...
public class HoIngeschrevene {
	...
	protected HoIngeschrevene(){}

	
	public HoIngeschrevene(long hiId, Jaartal jaartal, OnderwijsSoort ondCode, IscedCode iscedCode, String diploma, int aantal) {
		this.hiId = hiId;
