...
public class Gediplomeerden {
	...
	protected Gediplomeerden(){}

	
	public Gediplomeerden(long hgId, Jaartal jaartal, OnderwijsSoort ondCode, IscedCode iscedCode, String diploma, int aantal) {
		this.hgId = hgId;
